...
image_dir = r"C:\Users\hafee\OneDrive\Desktop\deep_learning\Dataset_Celebrities\cropped"

messi_images = os.listdir(os.path.join(image_dir, 'lionel_messi'))
maria_images = os.listdir(os.path.join(image_dir, 'maria_sharapova'))
roger_images = os.listdir(os.path.join(image_dir, 'roger_federer'))
serena_images = os.listdir(os.path.join(image_dir, 'serena_williams'))
virat_images = os.listdir(os.path.join(image_dir, 'virat_kohli'))
...
image_paths_to_predict = [
    r'C:\Users\hafee\OneDrive\Desktop\deep_learning\Dataset_Celebrities\cropped\lionel_messi\lionel_messi1.png',
    r'C:\Users\hafee\OneDrive\Desktop\deep_learning\Dataset_Celebrities\cropped\maria_sharapova\maria_sharapova1.png',
    r'C:\Users\hafee\OneDrive\Desktop\deep_learning\Dataset_Celebrities\cropped\roger_federer\roger_federer1.png',
    r'C:\Users\hafee\OneDrive\Desktop\deep_learning\Dataset_Celebrities\cropped\serena_williams\serena_williams2.png',
    r'C:\Users\hafee\OneDrive\Desktop\deep_learning\Dataset_Celebrities\cropped\virat_kohli\virat_kohli1.png',
]
